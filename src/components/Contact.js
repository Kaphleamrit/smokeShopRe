  ...
  return (
    <StyledContainer>
      <StyledPaper elevation={3}>
        ...
        <Typography variant="body1" paragraph style={{ fontWeight: '300', lineHeight: '1.6' }}>
          We would love to hear from you! Reach out to us with any questions, comments, or concerns.
        </Typography>
        <StyledDivider />
        <Box>
          <Typography variant="h6" gutterBottom style={{ fontWeight: '400', marginBottom: '10px' }}>
            Address:
          </Typography>
          <Typography variant="body2" paragraph style={{ fontWeight: '300', lineHeight: '1.6' }}>
